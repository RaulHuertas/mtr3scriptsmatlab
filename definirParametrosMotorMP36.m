...
%Valores del motor
Ra = 0.16;% resistencia de armadura
La = 79e-6;% inductancia armadura
J = Kgmm2ToKgm2(1386.1);%inercia rotacional motor
Kt = 0.05918; %constante torque
Kb = VoltagePerKRPMToVoltagePerHertz(6.2);% back emf constant
Bm = 0.000;% coeficiente de fricción viscosa
relacionEngranajes = 32.0/1;
...
function kgm2 = Kgmm2ToKgm2(units)
    kgm2 = units*1e-6;
end
