...
%Valores del motor
relacionEngranajes = 1.0/1.0;
Rm = 0.72;% resistencia de armadura
Lm = 1.5e-3;% inductancia armadura
J = gramsCM2ToKgMeters2(12358.5);%inercia rotacional motor
...
mechanicalTimeConstant = 8.71/1000.0;
te = electricalTimeConstant;
tm = mechanicalTimeConstant;
Bm = J/tm;% coeficiente de fricción viscosa


s= tf('s');
tfMotorParte1 = 1/(Lm*s+Rm)
tfMotorParte2 = 1/(J*s+Bm)
tfMotor = tfMotorParte1*tfMotorParte2
