...
Rm = 0.5;% resistencia de armadura
Lm = 3.9/1000;% inductancia armadura
Jm = gramsCM2ToKgMeters2(2718.9);%inercia rotacional motor
Kt = newtonCMToNewtonM(19.5); %constante torque
Kb = VoltagePerKRPMToVoltagePerRadS(20.4);% back emf constant
electricalTimeConstant = Lm/Rm;
mechanicalTimeConstant = 4.4/1000.0;
